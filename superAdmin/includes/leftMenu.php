            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li class="menu-title">ADMIN: &nbsp;&nbsp;&nbsp;<?php echo $staffFullName;?></li>
                        ...
                        <a href="index.php"><i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                         ...
                         <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"> <i class="menu-icon fa fa-user"></i>Attendance</a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-plus"></i><a href="seat.php">Mark Attendance</a></li>
								 <li><i class="fa fa-plus"></i><a href="attendance.php">Attendance Record</a></li>
								  <li><i class="fa fa-plus"></i><a href="attendance.php">Attendance Report</a></li>
                            </ul>
                 ...
                 <li class="menu-item-has-children dropdown <?php if($page=='session'){ echo 'active'; }?>">
                   ...
                   <li class="menu-title">Computer Science Engg.</li>
                   ...
                   <!-- <li class="menu-item-has-children dropdown <?php if($page=='department'){ echo 'active'; }?>">
                    ...
                    <li class="menu-item-has-children dropdown <?php if($page=='student'){ echo 'active'; }?>">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus"></i> <a href="createStudent.php">TY.BTech.DivA</a></li>
                            <li><i class="fa fa-eye"></i> <a href="viewStudent.php">View Student</a></li>
							<li><i class="fa fa-plus"></i> <a href="createStudent.php">TY.BTech.DivB</a></li>
                            <li><i class="fa fa-eye"></i> <a href="viewStudent.php">View Student</a></li>
                        </ul>
                    </li>
