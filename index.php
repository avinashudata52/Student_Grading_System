...
<head>
  ...
  <title>Digital Grading PHP</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      <a class="navbar-brand" href="index.php"><img src="assets/img/Sveri Colloge Logo.png" alt="Logo" style="width:80px;height:80px;"></a>
      <h1 class="logo mr-auto"><a href="index.php">Digital Grading System</a></h1>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex justify-content-center align-items-center" style="background-image: url('assets/img/COLLEGE PHOTO 1.jpg');">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1>Digital Grading System<br></h1>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Welcome To</h2><!-- Log on to codeastro.com for more projects! -->
          <p>SVERI's College Of Engineering</p>
        </div>

        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="assets/img/logo.jpeg" style="height:400px;" class="img-fluid" alt="">
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Digital Grading System</h3>
            <p>
              P.B. No. 54, Gopalpur, Pandharpur, Ranjani Road, <br>
              Gopalpur, Maharashtra 413304<br><br>
              <strong>Phone:</strong> 9511776720<br>
              <strong>Email:</strong>omdixit2826@gmail.com<br>
            </p>
          </div>
